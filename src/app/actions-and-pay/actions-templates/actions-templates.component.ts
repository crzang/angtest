...
export class ActionsTemplatesComponent implements OnInit {
  ...
  constructor() {
    this.templates = [
      {image: 'assets/img/templ-alpha.png', name: 'Моя альфа', lastUse: 'Последний 20 февраля', value: '4500 руб'},
      {image: '', name: 'Моя альфа', lastUse: 'Последний 20 февраля', value: '4500 руб'},
      {image: '', name: 'Моя альфа', lastUse: 'Последний 20 февраля', value: '4500 руб'},
      {image: '', name: 'Моя альфа', lastUse: 'Последний 20 февраля', value: '4500 руб'}
    ];
  }
