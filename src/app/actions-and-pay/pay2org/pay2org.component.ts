...
@Component({
  selector: 'app-pay2org',
  templateUrl: './pay2org.component.html',
  styleUrls: ['./pay2org.component.css']
})
export class Pay2orgComponent implements OnInit {
  items = [];
  accounts = [];
  ...
  constructor() {
    ...
    this.items = [
      {id: 1, label: 'Название организации', value: '', labelClass: 'itemLabel', valueClass: 'itemValue', valueType: 'text'},
      {id: 2, label: 'Номер счета получателя', value: '', labelClass: 'itemLabel', valueClass: 'itemValue', valueType: 'text'},
      {id: 3, label: 'ИНН', value: '', labelClass: 'itemLabel', valueClass: 'itemValue', valueType: 'number'},
      {id: 4, label: 'КПП', value: '', labelClass: 'itemLabel', valueClass: 'itemValue', valueType: 'number'},
